...
#  A banking application has a function check_balance(). Create two
# decorators: verify_user, which prints "User verified", and log_transaction,
# which prints "Transaction logged". Apply both decorators to check_balance()
